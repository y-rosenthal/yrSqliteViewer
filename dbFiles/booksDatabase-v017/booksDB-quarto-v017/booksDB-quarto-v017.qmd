...
```{r}
#| include: false
#| file: booksFiles/importToR/readCsvFiles-v007.R
```

```{r}
#| include: false

# The chunk above included the code for the function readCsvFiles

theCsvFiles = c("authors.csv", "publishers.csv", "titles.csv", "title_authors.csv", "royalties.csv")
readCsvFiles(dir="booksFiles/csv", files=theCsvFiles)
```
...
require(sqldf)
#authors = readCsvFiles("booksFiles/csv/authors.csv")
